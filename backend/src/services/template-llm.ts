...
- deliveryCourier is the shipping carrier or service. Use the actual carrier (USPS, UPS, FedEx, DHL) if shown. Otherwise use the service level: "eBay Economy", "Standard Shipping", etc. For Amazon: if "Prime" appears anywhere, use "Amazon Prime". Look for "Ship Via", "Shipping method", "Delivery" fields
